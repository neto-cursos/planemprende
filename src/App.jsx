...
import { HashRouter as Router, Routes as Switch, Route, useLocation } from 'react-router-dom';
...
import UnderContruction from './pages/UnderConstruction'
        ...
        <Children displaySidebar={displaySidebar} sidebar={auth ? true : false}>
          <AnimatedRoute>
            <Switch>
              ...
              <Route exact path="/recoverpassword" element={<RequireNoAuth><RecoverPassword /></RequireNoAuth>} />
              ...
              <Route exact path="/emprendimiento/:empr_id/cronograma" element={<Cronogramas/>/*<UnderContruction/>*/} />
              <Route exact path="/emprendimiento/cronograma" element={<Cronograma></Cronograma>} />
