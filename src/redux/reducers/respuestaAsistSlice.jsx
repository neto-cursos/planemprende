...
export const respuestaAsistSlice = createSlice({
    ...
    reducers: {
        ...
        addRespuestaBatch: (state, action) => {
            console.log(state, action);
            action.payload.map((resp)=>{
                state.respAsist.push(resp);
            })
            state.estado="ready";
        },
...
export const {addRespuestaBatch, addRespuesta, deleteRespuesta, updateRespuesta, resetRespuestaAsistida, reset,respAsistChgEmprId,changeResp2Send } = respuestaAsistSlice.actions
