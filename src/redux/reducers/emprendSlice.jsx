...
import {fetchEmprs,addNewEmprs,queryEmprs,removeEmprs,updateEmprs} from "./../actions/EmprActions";
...
export const emprendSlice = createSlice({
    ...
    extraReducers(builder) {
        builder
            ...
            .addCase(addNewEmprs.rejected, (state, action) => {
                state.status = 'failed'
                console.log("AddNewEmpr Failed")
                // console.log(action)
                //state.error = action.error.message
            })
            .addCase(addNewEmprs.pending, (state, action) => {
                state.status = 'pending'
                console.log("AddNewEmpr pending")
                //state.error = action.error.message
            })
            .addCase(addNewEmprs.fulfilled, (state, action) => {
            ...
            .addCase(removeEmprs.pending, (state, action) => {
                state.status = 'pending'
                console.log("RemoveEmpr Pending")
            })
            .addCase(removeEmprs.fulfilled, (state, action) => {
                state.status = 'fulfilled'
                console.log("RemoveEmpr fulfilled")

            })
            .addCase(removeEmprs.rejected, (state, action) => {
                state.status = 'failed'
            ...
            .addCase(queryEmprs.fulfilled,(state,action)=>{
