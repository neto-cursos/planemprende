...
export const menuPrincipalAuth =
    ...
    [
        ...
        { id: 4, texto: 'Sobre Nosotros', enlace: '/sobrenosotros', icon: null,textoAlt:'',enable:true, },
        { id: 5, texto: 'Soporte', enlace: '/contacto', icon: null,textoAlt:'Soporte',enable:true, },
    ...
    [
        { id: 1, texto: 'Inicio', enlace: '/', icon: null,textoAlt:'',enable:true, },
        { id: 2, texto: 'Panel De Control', enlace: '/welcome', icon: null,textoAlt:'Panel De Control',enable:true, },
        // { id: 3, texto: 'Cronograma', enlace: "/emprendimiento/:empr_id/cronograma", icon: null,textoAlt:'',enable:true, },
    ...
    [
        { id: 1, texto: 'Inicio', enlace: '/', icon: null,textoAlt:'',enable:true, },
        { id: 2, texto: 'Panel De Control', enlace: '/welcome', icon: null,textoAlt:'Panel De Control',enable:true, },
        // { id: 3, texto: 'Canvas', enlace: '/emprendimiento/:empr_id/bmc', icon: null,textoAlt:'',enable:true, },
