...
const ContactForm = () => {
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md dark:bg-gray-900 rounded-md">
      ...
      <div>
              <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nombre Completo</label>
          ...
          <div>
              <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Su Correo Electrónico</label>
          ...
          <div className="sm:col-span-2">
              <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Su mensaje</label>
