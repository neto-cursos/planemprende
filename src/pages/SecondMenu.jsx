...
import { queryEmprs } from '../redux/actions/EmprActions';
        ...
        <>
            ...
            >
                ...
                <div className="max-w-md w-full space-y-8">
                    ...
                    {enab===true&&<div className="relative bg-gradient-to-b from-teal-500 rounded-2xl w-60 h-40 mt-10 mx-auto overflow-hidden">
