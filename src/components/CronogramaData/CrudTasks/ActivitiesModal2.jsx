...
const ActivitiesModal = forwardRef(({ isOpen, handleClose, handleSubmit2, valueDate, valueDate2,
    ...
    const [valor, setValor] = React.useState('independiente');
            ...
            <Box sx={windowSize.innerWidth > 640 ? style : style2} component="form" onSubmit={handleSubmit(submitForm)}>
                ...
                <Controller
                    ...
                    render={({ field: { ref, ...field } }) => (
                        <RadioGroup {...field} onChange={handleChangeRG} value={valor} sx={{ display: 'inline-flex', flexDirection: 'row', pb: 2 }}>
                            <FormControlLabel
                                value="predecesora"
                                control={<Radio />}
                                label="¿predecesora?"
                ...
                />
                {(valor == 'paralela' || valor == 'predecesora') &&
                    <Controller
                        control={control}
