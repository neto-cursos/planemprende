...
import {
    deleteEmprend, getEmprsError,
    getEmprsStatus, setEmprStatus
} from './../../../redux/reducers/emprendSlice';
import { fetchEmprs, removeEmprs } from '../../../redux/actions/EmprActions';
...
const EmprendList = () => {
    ...
    const handleDelete = (id) => {
        ...
        dispatch(removeEmprs({ empr_id: id }));
    }
                            ...
                            <div className="flex items-center bg-gray-100 mb-4 shadow text-base" key={emprends.empr_id}>
                                <div className="flex-auto text-left px-4 py-2 m-1 w-3/4">
                                    <Link to={`/emprendimiento/${emprends.empr_id}`}>
                                        ...
                                        <p className="text-gray-600">Rubro: {emprends.empr_rubro} </p>
