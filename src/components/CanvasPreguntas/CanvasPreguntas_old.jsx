...
const ModelCanvasPreguntas = () => {
    ...
    //functions for multipleRefs
    const handleChange = (index, e,preg_id) => {
        console.log(index);
        console.log(e);
        console.log(preg_id);
    };
                ...
                <div className="py-3 pr-3 pl-10 col-span-2 md:col-span-2 bg-whitish rounded-md">
                    ...
                    {preguntas.preguntas.map((pregunta,index) => {
                        return pregunta.modu_id == modu_nume && <>
                            ...
                            {/* {inputRespRefs.current.map((ref, index) => ( */}
                                <input
                                    key={index}
                                    type="text"
                                    onChange={(e) => handleChange(index, e,pregunta.preg_id)}
                                    ref={inputRespRefs.current[index]}
                                />
                            {/* ))} */}
